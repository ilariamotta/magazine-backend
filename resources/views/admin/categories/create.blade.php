...
@section('title', 'Nuova categoria - Pixel Pop Admin')
        ...
        <div class="col-12 col-xl-10">
            <div class="row g-4">           
                ...
                <div class="col-12 col-lg-7">
                    <div class="bg-white rounded-4 shadow-sm p-4 p-md-5 h-100">
                        <h1 class="fw-bold mb-1">Nuova categoria</h1>
                        <p class="text-muted mb-4">
                            Crea una nuova sezione editoriale per Pixel Pop.
                        </p>
                        <form action="{{ route('admin.categories.store') }}" method="POST">
                            ...
                            <div class="mb-4">
                                ...
                                <input type="color" id="color" name="color" class="form-control form-control-color input-pixel" value="#ff4fa3">
                            </div>
